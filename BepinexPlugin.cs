...
namespace ShouMod
{
    [BepInPlugin(ShouMod.PInfo.GUID, ShouMod.PInfo.Name, ShouMod.PInfo.version)]
    ...
    public class BepinexPlugin : BaseUnityPlugin
    {
        ...
        private static readonly Harmony harmony = ShouMod.PInfo.harmony;
        ...
        internal static DirectorySource directorySource = new DirectorySource(ShouMod.PInfo.GUID, "");
        ...
        private void Awake()
        {
            ...
            EnemyUnitTemplate.AddBossNodeIcon(nameof(ShouMod.Enemies.SampleCharacterMod), getSprite);
        }
